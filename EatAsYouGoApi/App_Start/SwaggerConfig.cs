...
using EatAsYouGoApi;
using EatAsYouGoApi.Controllers;
...
namespace EatAsYouGoApi
{
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "EatAsYouGoApi");
        ...
        //    public void Apply(Operation operation, SchemaRegistry schemaRegistry, ApiDescription apiDescription)
        //    {
        //        var userLogin = operation.operationId.Equals("User_" + nameof(UserController.LoginUser), StringComparison.OrdinalIgnoreCase);
